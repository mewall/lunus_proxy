...
nvcc -c -I../cub-1.8.0 -arch=sm_70 -DDEBUG -DLUNUS_NUM_JBLOCKS=1 -DLUNUS_NUM_IBLOCKS=1 -DDEBUG \
...
#clang++ -g -O3 -fopenmp -fopenmp-targets=nvptx64-nvidia-cuda -fPIC -DLUNUS_NUM_JBLOCKS=1 -DLUNUS_NUM_IBLOCKS=1 -DDEBUG -I. -o lunus_proxy lunus_proxy.cpp -L. -llunus_with_cub -L/usr/common/software/sles15_cgpu/cuda/10.1.243/lib64 -lcudart
