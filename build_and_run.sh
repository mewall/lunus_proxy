...
#export CFLAGS="-g -O3 -fopenmp -fPIC -DUSE_OPENMP -DLUNUS_TEAMS=128 -DLUNUS_THREADS=32 -DDEBUG -I. -L."
export CFLAGS="-g -O3 -fopenmp -fPIC -DUSE_OPENMP -DUSE_OFFLOAD -DLUNUS_TEAMS=128 -DLUNUS_THREADS=32 -DDEBUG -I. -L."
